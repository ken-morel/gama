...
<div class="hero">
    <div class="content-wrapper">
        <div class="hero-content">
            ...
            <p class="subtitle">
                A lightweight, minimalist game engine that combines a powerful C
                library with a modern toolchain. Perfect for students learning C
                programming and developers who want a zero-dependency,
    ...
    <div class="content-wrapper">
        <div class="section-header">
            ...
            <p class="section-subtitle">
                Everything you need to build impressive 2D games and
                visualizations
            </p>
        </div>
...
<div class="principles">
    <div class="container">
        <div class="section-header">
            ...
            <p class="section-subtitle">
                Built with educational excellence and practical safety at its
                core
            </p>
        </div>
    ...
    <div class="container">
        <div class="applications-container">
            <div class="section-header">
                ...
                <p class="section-subtitle">
                    Gama is not just for games! Perfect for education,
