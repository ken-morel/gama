 ...
 * @return The pointer at the specified index, or NULL if the index is out of bounds.
 */
...
void *gm_ptr_list_last(gmPtrList list) {
    if (gm_ptr_list_is_empty(list)) return NULL;
...
static inline gmBodies gm_bodies_insert_at(gmBodies list, size_t idx, gmBody* value) {
