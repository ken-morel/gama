#ifndef GM_WIDGETS_THEME_H_INCLUDED
#define GM_WIDGETS_THEME_H_INCLUDED
 ...
 *
 * @return A pointer to the saved theme cache entry, or NULL if the cache is
 * full.
 */
 ...
 * it to the global widget themes. It always returns 1 in case no theme was
 * saved.
 */
int gmw_restore() {
...
#endif // GM_WIDGETS_THEME_H_INCLUDED
