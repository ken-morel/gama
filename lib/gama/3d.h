 ...
 *
 * This file serves as a convenient single-point inclusion for all
 * 3D-related functionalities within the Gama engine, including
 * mesh loading, scene management, camera controls, and projection.
 *
 * It includes:
